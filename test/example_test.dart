...
void main() {
  group('Example prompt file loading', () {
    test('loads example.prompt.yml correctly', () async {
      ...
      expect(file.existsSync(), isTrue, reason: 'example.prompt.yml should exist');
    ...
    test('loads minimal.prompt.yml correctly', () async {
      ...
      expect(file.existsSync(), isTrue, reason: 'minimal.prompt.yml should exist');
      ...
      expect(prompt.messages![0].content, 
        equals('You are a text summarizer. Your only job is to summarize text given to you.'));
    ...
    test('prompt files can be loaded and serialized', () async {
      ...
      final files = ['example/example.prompt.yml', 'example/minimal.prompt.yml'];
